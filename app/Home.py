"""
Home — cổng vào dashboard AIsle.

Thiết kế kế thừa bảng màu/font từ Brand/pitch/aisle-project-pitch.html để
dashboard và pitch deck nhất quán thương hiệu (không phải giao diện Streamlit
mặc định). Chi tiết theme xem app/theme.py.
"""
import os
...
st.markdown(
	"""
	<div class="aisle-eyebrow" style="margin-top:12px;">Đi qua từng gian</div>
	""",
	unsafe_allow_html=True,
)
